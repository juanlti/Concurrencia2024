...
public class Test {
    ...
    public static void main(String[] args) {
        ...
        Impresion A1 = new Impresion('A', 53);
        Impresion A2 = new Impresion('A', 35);
        ...
        for (int i = 0; i < usuariosA.length; i++) {
            usuariosA[i] = new Usuario(gestor, 'A', 10);

        }
        for (int i = 0; i < usuariosB.length; i++) {
            usuariosB[i] = new Usuario(gestor, 'B', 10);

        }
        for (int i = 0; i < usuariosX.length; i++) {
            usuariosX[i] = new Usuario(gestor, 'X', 10);
